...
def on_message(client, userdata, message):
    ...
    print(size)
    start_time1 = time.time() #submit TX
    tx_hash = contract.functions.setData(t).transact()
    end_time1 = time.time() #submit TX
    print("delay1: ", end_time1 - start_time1)
    print(tx_hash)
    start_time2 = time.time() #Tx Receipt
    tx_receipt = web3.eth.waitForTransactionReceipt(tx_hash)
    ...
    print(blockhash)
    end_time2 = time.time() #Tx Receipt
    print("delay2: ", end_time2 - start_time2)
